...
const SearchBar = ({ 
  ...
  return (
    <form onSubmit={handleSearch} className="hidden md:flex flex-grow max-w-2xl items-center mx-8">
      ...
      <div className="flex w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900/50 focus-within:ring-2
       focus-within:ring-blue-500/20 focus-within:border-blue-500 overflow-hidden transition-all shadow-sm">
        ...
        <div className="flex items-center bg-slate-100 dark:bg-slate-800 border-r border-slate-300 dark:border-slate-700">
          ...
          <button 
            ...
            className="px-3 py-3 text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400
             hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors tooltip"
        ...
        {/* SEARCH BUTTON: Right */}
        <button type="submit" className="px-5 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:text-blue-600
         dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors">
          <Search size={20} />
        </button>
      </div>
    </form>
